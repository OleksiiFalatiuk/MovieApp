...
object MovieData {
    fun getMovie() = arrayListOf(
        Movie(
            ...
            arrayListOf(
                Actor(1, "Robert Downey Jr.", R.drawable.daun),
                Actor(2, "Chris Evans", R.drawable.evans),
                Actor(3, "Mark Ruffalo", R.drawable.ruffalo),
                Actor(4, "Chris Hemsworth", R.drawable.thor),
            )
        ),
        Movie(
            2,
